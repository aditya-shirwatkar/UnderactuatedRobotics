...
class CartPoleContiEnv(gym.Env):
    ...
    def step(self, action):
        ...
        xacc = (force + (mp*sintheta*((l*(x_dot**2)) + (g*costheta))))/(mc + (mp*(sintheta**2)))
        thetaacc = ((-force*costheta) + (-mp*l*costheta*sintheta*(x_dot**2)) + (-(mp+mc)*g*sintheta))/(l*(mc + (mp*(sintheta**2))))
